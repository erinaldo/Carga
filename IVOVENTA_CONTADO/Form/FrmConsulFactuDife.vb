Public Class FrmConsulFactuDife
    ...
    Private Sub listar_facturas()
        Try
            ...
            '
            'Datahelper
            dvListar_facturas = ObjFactura.sp_l_desti_dife_carga()
            '
            FORMAT_GRILLA3()
    ...
    Sub FORMAT_GRILLA3()
        ...
        With DGV3
            .Columns.AddRange(RAZON_SOCIAL, TIPO_COMPROBANTE, SERIE_FACTURA, NRO_FACTURA, FECHA_FACTURA, SIMBOLO_MONEDA, SUB_TOTAL, MONTO_IMPUESTO, TOTAL_COSTO, FORMA_PAGO, LOGIN, ESTADO_REGISTRO, ESTADO_REGISTRO_ENVIO, NOMBRE_AGENCIA, Nombre_Unidad_ORI, Nombre_Unidad_DESTI, TIPO_ENTREGA, FECHA_SALIDA_G_T, NRO_GUIA_TRANSPORTISTA_G_T, Nombre_Unidad_DESTI_G_T)

        End With
    End Sub

    Private Sub FrmConsulFactuDife_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulFactuDife_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "LISTADO DE VENTAS CON DESTINOS DIFERENTES A LA GUIA DE TRANSPORTISTA"
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        ObjReport.printrptB(False, "", "FAC012.RPT", _
