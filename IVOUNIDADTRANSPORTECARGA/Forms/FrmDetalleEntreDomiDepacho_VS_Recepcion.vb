Public Class FrmDetalleEntreDomiDepacho_VS_Recepcion
    ...
    Private Sub FrmDetalleEntreDomiDepacho_VS_Recepcion_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub FrmPass_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            With nfrmdespacho_vs_recepcion
                ...
                'Datahelper
                Me.DGV.DataSource = ObjDESPACHO_RECEPCION.sp_con_x_entre_domi_vista()
