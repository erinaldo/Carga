...
Public Class dtoConsuRecojos
    ...
    '    Dim ObjUnd2 As Object() = {"PKG_IVORECEPCION_RECOJO_CARGA.SP_LISTA_CONSULTA_RECOJO", 0}
    ...
    Public Function Lista() As DataSet
        ...
        Try
            ...
            db_bd.CrearComando("PKG_IVORECEPCION_RECOJO_CARGA.SP_LISTA_CONSULTA_RECOJO", CommandType.StoredProcedure)
    ...
    Public Function Buscar() As DataTable
        ...
        Try
            ...
            db_bd.Conectar()
            ' Invocando  al procedimiento almacenado 
            db_bd.CrearComando("PKG_IVORECEPCION_RECOJO_CARGA.SP_LISTA_CONSULTA_RECOJO_DET", CommandType.StoredProcedure)
            'Adicionando variables para el uso de parámetros de acuerdo al proc. almacenado input 
            db_bd.AsignarParametro("iIDUNIDAD_TRANSPORTE", StMovil, OracleClient.OracleType.Int32)
            db_bd.AsignarParametro("iIDRUTA_ENTREGA_RECOJO", StRuta, OracleClient.OracleType.Int32)
            db_bd.AsignarParametro("iIDESTADO_REGISTRO", StEstado, OracleClient.OracleType.Int32)
            db_bd.AsignarParametro("iNU_DOCU_SUNA", StRuc, OracleClient.OracleType.VarChar)
            db_bd.AsignarParametro("iRAZON_SOCIAL", StCliente, OracleClient.OracleType.VarChar)
