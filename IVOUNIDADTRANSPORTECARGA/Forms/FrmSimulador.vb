Public Class FrmSimulador
    ...
    Private Sub FrmSimulador_Activated(ByVal sender As Object, ByVal e As System.EventArgs)
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmSimulador_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs)
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
        Acceso.Eliminar(Me, G_Fila)
    End Sub

    Private Sub FrmSimulador_Load(ByVal sender As Object, ByVal e As System.EventArgs)
...
listar:
    ...
    Private Sub TxtBus_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs)
    ...
    Private Sub cbobus_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub BtSacar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        With dgvSeleccionados
    ...
    Private Sub btnNinguno_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        With dgvSeleccionados
    ...
    Private Sub txtDocumento_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Asc(e.KeyChar) = Keys.Enter Then
    ...
    Private Sub cboTipoDocumento_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        dgvDisponibles.Rows.Clear()
    ...
    Private Sub dtpFin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        dgvDisponibles.Rows.Clear()
        bActualiza = False
        cboCliente.SelectedIndex = 0
        bActualiza = True
    ...
    Private Sub cboCliente_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Asc(e.KeyChar) = Keys.Space Then
            cboCliente.SelectedIndex = 0
        End If
    End Sub

    Private Sub cboCliente_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'dgvDisponibles.Rows.Clear()
        'Return
        If bInicio = False Then
    ...
    Private Sub btnDocumento_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ToolGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If dgvSeleccionados.Rows.Count = 0 Then
    ...
    Private Sub ToolEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub dgvLista_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        Editar()
    End Sub

    Private Sub ToolEditar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Editar()
    End Sub
    ...
    Private Sub cboOperador_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        dgvDisponibles.Rows.Clear()
        lblRegistros1.Text = "0"
    ...
    Private Sub txtPeso2_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        txtPeso2.SelectAll()
    End Sub

    Private Sub txtPeso2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Asc(e.KeyChar) = Keys.Enter Then
        Else
            Dim tb As TextBox = CType(sender, TextBox)
            Dim chr As Char = e.KeyChar
    ...
    Private Sub txtPeso2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        dgvDisponibles.Rows.Clear()
        bActualiza = False
        cboCliente.SelectedIndex = 0
        bActualiza = True
    ...
    Private Sub cboAgencia_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        dgvDisponibles.Rows.Clear()
        If cboCliente.Items.Count > 0 Then
            bActualiza = False
            cboCliente.SelectedIndex = 0
    ...
    Private Sub cboOrigen_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'iBultos2 = 0
        'iPeso2 = 0
        'iVolumen2 = 0
        'iSubtotal2 = 0
    ...
    Private Sub cboUsuario_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If objSimulador Is Nothing Then Return
        Listar()
    End Sub
    ...
    Private Sub TxtBus_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Asc(e.KeyChar) = Keys.Enter Then
    ...
    Private Sub dgvSeleccionados_CellValidating(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellValidatingEventArgs)
        Try
    ...
    Private Sub dgvSeleccionados_CellValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
        Try
            If bInicio Then
                bInicio = False
                Return
    ...
    Private Sub dgvSeleccionados_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)
    ...
    Private Sub cboUnidadOrigen_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Asc(e.KeyChar) = Keys.Enter Then
            cboUnidadDestino.Focus()
        End If
    End Sub

    Private Sub cboUnidadDestino_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Asc(e.KeyChar) = Keys.Enter Then
            cboTramo.Focus()
        End If
    End Sub

    Private Sub cboUnidadDestino_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub cboTramo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Asc(e.KeyChar) = Keys.Enter Then
    ...
    Private Sub cboTramo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnSeleccionarContactos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
