Public Class FrmConsultaGeneral2
    ...
    Public Sub txtDocumento_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtDocumento.KeyPress
    ...
    Private Sub Mostrar(ByVal n As Integer)
        ...
        With objConsultaGeneral1.curVenta
            ...
            'hlamas 18-09-2013
            If .Rows(n).Item("dt").ToString.Length > 0 Then
    ...
    Private Sub LblLiqDevCargo_Click(sender As Object, e As System.EventArgs) Handles LblLiqDevCargo.Click
