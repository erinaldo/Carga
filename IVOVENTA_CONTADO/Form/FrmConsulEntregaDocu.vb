Public Class FrmConsulEntregaDocu
    ...
    Private Sub listar_facturas()
        Try
            ...
            'dvListar_facturas = ObjFactura.sp_Consul_GUIAS_RECEPCION_DOCU(VOCONTROLUSUARIO, P_ENTRE)
            dvListar_facturas = ObjFactura.sp_Consul_GUIAS_RECEPCION_DOCU(P_ENTRE)
            '
    ...
    Sub FORMAT_GRILLA3()
        ...
        With DGV3
            .Columns.AddRange(RAZON_SOCIAL, TIPO_COMPROBANTE, NRO_GUIA, FORMA_PAGO, FECHA_GUIA, LOGIN, Tipo_Recepcion_Docu, NOMBRE_AGENCIA, Nombre_Unidad_ORI, Nombre_Unidad_DESTI, TIPO_ENTREGA, ESTADO_REGISTRO, ESTADO_REGISTRO_ENVIO)

        End With
    End Sub

    Private Sub FrmConsulEntregaDocu_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulEntregaDocu_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Recepción de Documentos"
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        ObjReport.printrptB(False, "", "GUI013.RPT", _
                        ...
                        "P_IDTIPO_RECEPCION_DOCU;" & .IDTIPO_RECEPCION_DOCU)
