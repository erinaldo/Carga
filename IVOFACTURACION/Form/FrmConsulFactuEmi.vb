Public Class FrmConsulFactuEmi
    ...
    Public Sub listar_facturas()
        Try
            ...
            LblRegistros2.DataSource = Nothing
    ...
    Private Sub FrmConsulFactuEmi_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulFactuEmi_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Consulta de Facturas Emitidas"
                ...
                Try
                    ...
                    With ObjFactura
                        ...
                        If Me.rbdeta.Checked = True Then
                            ObjReport.printrptB(False, "", "FAC004.RPT",
                            "P_MONTO_IMPUESTO;" & FormatNumber(Me.dvListar_facturas.Table.Rows(Me.DGV3.CurrentRow.Index)("MONTO_IMPUESTO"), 2, , , TriState.True), _
                            "P_TOTAL_COSTO;" & FormatNumber(Me.dvListar_facturas.Table.Rows(Me.DGV3.CurrentRow.Index)("TOTAL_COSTO"), 2, , , TriState.True), _
                            "P_IDFACTURA;" & .IDFACTURA, _
                            "P_NRO_PREFACTURA;" & PREFACTURA)
                        ElseIf Me.rbgene.Checked = True Then
                            ObjReport.printrpt_sub_report("FAC027.rpt", False, "", "FAC026.rpt", _
                        ...
                        ElseIf Me.rbcobra.Checked = True Then
                           ...
                           "P_IDFACTURA;" & .IDFACTURA, _
                            "P_NRO_PREFACTURA;" & PREFACTURA)
                        ElseIf Me.RBLISTA_GENE.Checked = True Then
                            ObjReport.printrptB(False, "", "FAC028.rpt", _
                            "p_idpersona;" & .IDPERSONA, _
                            "p_idforma_pago;" & .IDFORMA_PAGO, _
                            "p_idtipo_moneda;" & .IDTIPO_MONEDA, _
                            "p_idagencias;" & .IDAGENCIAS, _
                            ...
                            "p_fecha_inicial;" & .FECHA_INICIO, _
                            "p_fecha_final;" & .FECHA_FINAL)
                        ElseIf Me.RBACU_MENSU.Checked = True Then
                            ObjReport.printrptB(False, "", "FAC029.rpt", _
                            "p_idpersona;" & .IDPERSONA, _
                            "p_idforma_pago;" & .IDFORMA_PAGO, _
                            "p_idtipo_moneda;" & .IDTIPO_MONEDA, _
                            "p_idagencias;" & .IDAGENCIAS, _
                            ...
                            "p_titulo;" & "(Desde " & .FECHA_INICIO & " Hasta " & .FECHA_FINAL + ")")
                        ElseIf Me.rbPersonalizado.Visible And Me.rbPersonalizado.Checked Then
                            If Me.rbPersonalizado.Tag = 2 Then
                                'Quimica Suiza
                                ObjReport.printrptB(False, "", "FAC104.RPT",
                                "P_MONTO_IMPUESTO;" & FormatNumber(Me.dvListar_facturas.Table.Rows(Me.DGV3.CurrentRow.Index)("MONTO_IMPUESTO"), 2, , , TriState.True), _
                                "P_TOTAL_COSTO;" & FormatNumber(Me.dvListar_facturas.Table.Rows(Me.DGV3.CurrentRow.Index)("TOTAL_COSTO"), 2, , , TriState.True), _
                                "P_IDFACTURA;" & .IDFACTURA, _
                                "P_NRO_PREFACTURA;" & PREFACTURA)
                            Else
                                'Eckerd
                                ObjReport.printrptB(False, "", "FAC103.RPT",
                                "P_MONTO_IMPUESTO;" & FormatNumber(Me.dvListar_facturas.Table.Rows(Me.DGV3.CurrentRow.Index)("MONTO_IMPUESTO"), 2, , , TriState.True), _
                                "P_TOTAL_COSTO;" & FormatNumber(Me.dvListar_facturas.Table.Rows(Me.DGV3.CurrentRow.Index)("TOTAL_COSTO"), 2, , , TriState.True), _
                                "P_IDFACTURA;" & .IDFACTURA, _
                                "P_NRO_PREFACTURA;" & PREFACTURA)
            ...
            If e.KeyCode = 13 Then
                ...
                If Not Iwinlistar_persona_todos.IndexOf(txtidpersona.Text) = -1 Then
                    With ObjPersona
                        ...
                        If ObjPersona.IDPERSONA = ID_PERSONA_ECKERD Then
                            Me.rbPersonalizado.Text = "Subcuenta SAP"
                            Me.rbPersonalizado.Tag = 1
                            Me.rbPersonalizado.Visible = True
                        ElseIf ObjPersona.IDPERSONA = ID_PERSONA_QUIMICA_SUIZA Then
                            Me.rbPersonalizado.Text = "DT"
                            Me.rbPersonalizado.Tag = 2
                            Me.rbPersonalizado.Visible = True
                        End If
    ...
    Private Sub txtCodigoCliente_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCodigoCliente.TextChanged
        ...
        Me.LblRegistros2.DataSource = Nothing
    End Sub
    ...
    Private Sub rbcobra_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbcobra.CheckedChanged, RBACU_MENSU.CheckedChanged
    ...
    rbgene.GotFocus, _
    rbdeta.GotFocus, _
    rbcobra.GotFocus, RBLISTA_GENE.GotFocus, RBACU_MENSU.GotFocus
        Try
            limpiar()
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "Seguridad Sistema", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub rblistmovimensu_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
    Handles _
        rbgene.CheckedChanged, _
    rbdeta.CheckedChanged, _
    rbcobra.CheckedChanged, RBLISTA_GENE.CheckedChanged
    End Sub
    ...
    Private Sub LblRegistros2_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles LblRegistros2.CellContentClick

    End Sub

    Private Sub LblRegistros2_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles LblRegistros2.RowsAdded
        Me.LblRegistros3.Text = FormatNumber(NumeroRegistro(Me.LblRegistros2), 0)
    End Sub

    Private Sub LblRegistros2_RowsRemoved(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles LblRegistros2.RowsRemoved
        Me.LblRegistros3.Text = FormatNumber(NumeroRegistro(Me.LblRegistros2), 0)
    End Sub
    ...
    Private Sub rbSubcuentaSap_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles rbPersonalizado.CheckedChanged
