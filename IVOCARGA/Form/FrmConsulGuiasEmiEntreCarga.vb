Public Class FrmConsulGuiasEmiEntreCarga
    ...
    Private Sub listar_GUIAS()
        Try
            ...
            End If
            'datahelper
            dvListar_guias = ObjFactura.SP_CONSUL_GUIAS_ETREGA()
            FORMAT_GRILLA3()
    ...
    Sub FORMAT_GRILLA3()
        ...
        With DGV3
            ...
            .Columns.AddRange(NOMBRE_AGENCIA, LOGIN, RAZON_SOCIAL, SERIE_GUIA_ENVIO, NRO_GUIA, FECHA_GUIA, FORMA_PAGO, SIMBOLO_MONEDA, SUB_TOTAL, MONTO_IMPUESTO, TOTAL_COSTO, ESTADO_REGISTRO)

        End With
    End Sub

    Private Sub FrmConsulGuiasEmiEntreCarga_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulGuiasEmiEntreCarga_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Consulta de Entrega de Cargos"
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        ObjReport.printrptB(False, "", "GUI009.RPT", _
