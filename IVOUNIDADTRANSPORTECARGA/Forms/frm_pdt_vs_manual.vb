Public Class frm_pdt_vs_manual
#Region "Variables"
...
#Region "Eventos"
    ...
    Private Sub frm_pdt_vs_manual_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub
    ' Dispose  
    Private Sub frm_pdt_vs_manual_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            ObjReport.Dispose()
        Catch
        End Try
    ...
    Private Sub frm_pdt_vs_manual_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
        Acceso.Eliminar(Me, G_Fila)
    End Sub
    'load
    Private Sub frm_pdt_vs_manual_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.ShadowLabel1.Text = "Consulta de Bultos leídos con Pdt contra Forma Manual"
            ...
            If objbultos_leidos_pdt_vs_manual.fn_load_bultos_leidos_pdt_vs_manual Then
    ...
    End Sub
    'Imprimir 
    Private Sub frm_pdt_vs_manual_MenuImprimir() Handles Me.MenuImprimir
        Try
            ObjReport.Dispose()
        Catch
        End Try
    ...
    'Salir 
    Private Sub frm_pdt_vs_manual_MenuSalir() Handles Me.MenuSalir
        Me.Close()
    End Sub
    'Btn_filtrar 
    Private Sub btn_filtrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_filtrar.Click
        ...
        'Mod.07/10/2009 -->Omendoza - Pasando al datahelper -  
        '
        If objbultos_leidos_pdt_vs_manual.fn_bultos_leidos_pdt_vs_manual() Then
...
#End Region
    ...
    Private Sub dgv_pdt_vs_manual_RowsAdded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsAddedEventArgs) Handles dgv_pdt_vs_manual.RowsAdded
        Me.lblRegistros.Text = FormatNumber(NumeroRegistro(Me.dgv_pdt_vs_manual) - 1, 0)
