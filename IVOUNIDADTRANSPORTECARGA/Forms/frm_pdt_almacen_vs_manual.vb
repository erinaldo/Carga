Public Class frm_pdt_almacen_vs_manual
#Region "Variables"
    ...
    Dim objbultos_leidos_almacen_pdt_vs_manual As New dtobultos_leidos_pdt_vs_manual
    '
...
#Region "Eventos"
    ...
    Private Sub frm_pdt_almacen_vs_manual_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub
    ' Dispose  
    Private Sub frm_pdt_almacen_vs_manual_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            ObjReport.Dispose()
        Catch
        End Try
    ...
    Private Sub frm_pdt_almacen_vs_manual_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
        Acceso.Eliminar(Me, G_Fila)
    End Sub
    'load
    Private Sub frm_pdt_almacen_vs_manual_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.ShadowLabel1.Text = "Consulta de Bultos leídos con Pdt en el Almacén contra Forma Manual"
            ...
            ' 
            objbultos_leidos_almacen_pdt_vs_manual.li_idagencias = dtoUSUARIOS.iIDAGENCIAS
            objbultos_leidos_almacen_pdt_vs_manual.vi_fecha_inicio = CType(DTPFECHAINICIOFACTURA.Value, String)
            objbultos_leidos_almacen_pdt_vs_manual.vi_fecha_final = CType(DTPFECHAFINALFACTURA.Value, String)
            '
            li_agencia = dtoUSUARIOS.iIDAGENCIAS
            'Mod.07/10/2009 -->Omendoza - Pasando al datahelper -  
            If objbultos_leidos_almacen_pdt_vs_manual.fn_load_bultos_leidos_almacen_pdt_vs_manual Then
                'odba.Fill(dt_agencias, objbultos_leidos_almacen_pdt_vs_manual.rst_agencia)
                'odba.Fill(dt_bultos_leidos_pdt_vs_manual, objbultos_leidos_almacen_pdt_vs_manual.rst_bultos_leidos_pdt_vs_manual)
                '
                dt_agencias = objbultos_leidos_almacen_pdt_vs_manual.dt_rst_agencia
                dt_bultos_leidos_pdt_vs_manual = objbultos_leidos_almacen_pdt_vs_manual.dt_rst_bultos_leidos_pdt_vs_manual
                '
    ...
    End Sub
    'Imprimir 
    Private Sub frm_pdt_almacen_vs_manual_MenuImprimir() Handles Me.MenuImprimir
        Try
            ObjReport.Dispose()
        Catch
        End Try
    ...
    End Sub
    'Salir 
    Private Sub frm_pdt_almacen_vs_manual_MenuSalir() Handles Me.MenuSalir
        Me.Close()
    End Sub
    'Btn_filtrar 
    Private Sub btn_filtrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_filtrar.Click
        objbultos_leidos_almacen_pdt_vs_manual.li_idagencias = CType(Me.cbm_agencias.SelectedValue, Long)
        objbultos_leidos_almacen_pdt_vs_manual.vi_fecha_inicio = CType(DTPFECHAINICIOFACTURA.Value, String)
        objbultos_leidos_almacen_pdt_vs_manual.vi_fecha_final = CType(DTPFECHAFINALFACTURA.Value, String)
        '
        If objbultos_leidos_almacen_pdt_vs_manual.fn_bultos_leidos_almacen_pdt_vs_manual() Then
