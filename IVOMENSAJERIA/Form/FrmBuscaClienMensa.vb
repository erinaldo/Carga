Public Class FrmBuscaClienMensa
    ...
    Private Sub FrmBuscaClienMensa_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmBuscaClienMensa_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
        Acceso.Eliminar(Me, G_Fila)
    End Sub
    Private Sub FrmBuscaClien_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.TxtNu_Docu_suna.Text = RGT_CODIGO_CLIENTE
            Me.TxtRazon_Social.Text = RGT_RAZON_SOCIAL
            '
            ...
            End If
            '
            OBJPersona.NU_DOCU_SUNA = RGT_CODIGO_CLIENTE
            OBJPersona.RAZON_SOCIAL = RGT_RAZON_SOCIAL
            format1()
            Me.dgv1.Focus()
            '
            bIngreso = False
    ...
    Private Sub BtnSalir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSalir.Click
        nFrmManteMensajeriaPersona.Txtnu_docu_suna.Text = ""
        nFrmManteMensajeriaPersona.Txtrazon_social.Text = ""
        nFrmManteMensajeriaPersona.Txtrazon_social.Tag = ""
        Close()
    End Sub
    Private Sub format1()
        dgv1.Columns.Clear()
        ...
        With dgv1
            ...
            'datahelper
            '.DataSource = OBJPersona.SP_LISTAR_CLIENTES(cnn)
    ...
    Private Sub BAcep_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BAcep.Click
        If Me.dgv1.RowCount <= 0 Then
            Exit Sub
        End If
        nFrmManteMensajeriaPersona.Txtnu_docu_suna.Text = dgv1.CurrentRow.Cells("nu_docu_suna").Value
        nFrmManteMensajeriaPersona.Txtrazon_social.Text = dgv1.CurrentRow.Cells("razon_social").Value
        nFrmManteMensajeriaPersona.Txtrazon_social.Tag = dgv1.CurrentRow.Cells("idpersona").Value
        Close()
    End Sub
