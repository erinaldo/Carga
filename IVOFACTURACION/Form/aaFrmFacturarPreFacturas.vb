Public Class FrmFacturarPreFacturas
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            ...
            If MsgBox("Esta seguro de anular esta factura", MsgBoxStyle.YesNo, "Seguridad del Sistema") = MsgBoxResult.No Then Exit Sub
            Dim obj As New ClsLbTepsa.dtoFACTURA
            With obj
                .IDFACTURA = dvListar_facturas.Table.Rows(DGV3.CurrentRow.Index)("IDFACTURA")
            ...
            Case 2
                ...
                Try
                    ...
                    For Each row As DataRow In dt.Rows
                        ...
                        obj.EscribirLinea(y + 6, 13, cmbDireccion.Text)
