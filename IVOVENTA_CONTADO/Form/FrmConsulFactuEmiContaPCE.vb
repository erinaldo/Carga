Public Class FrmConsulFactuEmiContaPCE
    ...
    Private Sub listar_facturas()
        Try
            ...
            If Me.RBENTRE.Checked = True Then
                P_ENTRE = 1
            ElseIf Me.RBSIN_ENTRE.Checked = True And chkStockTotal.Checked = False Then
                P_ENTRE = 0
            ElseIf Me.RBSIN_ENTRE.Checked = True And chkStockTotal.Checked = True Then
                P_ENTRE = 3
            Else
                P_ENTRE = 2
            End If
            ...
            If P_ENTRE = 1 And Me.dtpPeriodo.Checked Then
                intOpcion = 1
                strInicio = "01/" & Me.dtpPeriodo.Value.Month.ToString.PadLeft(2, "0") & "/" & Me.dtpPeriodo.Value.Year
                strFin = UltimoDiaMesAño(Me.dtpPeriodo.Value.Month, Me.dtpPeriodo.Value.Year).ToString.PadLeft(2, "0") & "/" & _
                Me.dtpPeriodo.Value.Month.ToString.PadLeft(2, "0") & "/" & Me.dtpPeriodo.Value.Year
            End If


            ObjFactura.IDPROCESOS = ObtieneProducto(CboTipo.SelectedIndex)
            ObjFactura.FACTURADO = CboEstado.SelectedIndex


            'Mod.21/09/2009 -->Omendoza - Pasando al datahelper, se quito el parametro VOCONTROLUSUARIO   
            dvListar_facturas = ObjFactura.SP_ConsulFactuEmiContaPCE(P_ENTRE, intOpcion, strInicio, strFin)
            '
    ...
    Function ObtieneProducto(id As Integer) As Integer
        Select Case id
            Case 0
                Return -1
            Case 1
    ...
    Sub FORMAT_GRILLA3()
        ...
        With DGV3
            .Columns.AddRange(RAZON_SOCIAL, TIPO, TIPO_COMPROBANTE, NRO_GUIA, SERIE_FACTURA, NRO_FACTURA, FECHA_FACTURA, SIMBOLO_MONEDA, SUB_TOTAL, MONTO_IMPUESTO, TOTAL_COSTO, FORMA_PAGO, LOGIN, ESTADO_REGISTRO, ESTADO_REGISTRO_ENVIO, NOMBRE_AGENCIA, Nombre_Unidad_ORI, Nombre_Unidad_DESTI, TIPO_ENTREGA, FECHA_ENTREGA)

        End With
    End Sub

    Private Sub FrmConsulFactuEmiContaPCE_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulFactuEmiContaPCE_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Pago Contra Entrega"
            ...
            CboTipo.Items.Add(" (TODO)")
            CboTipo.Items.Add("ENCOMIENDAS")
            CboTipo.Items.Add("CARGA ACOMPAÑADA")
            CboTipo.Items.Add("COURIER")
            CboTipo.Items.Add("COURIER OFFICE")
            CboTipo.Items.Add("SOBRES")
            CboTipo.Items.Add("BOX")
            CboTipo.SelectedIndex = 0

            CboEstado.Items.Add(" (TODO)")
            CboEstado.Items.Add("Cancelado")
            CboEstado.Items.Add("Sin Cancelar")
        ...
        Select Case Me.TabMante.SelectedIndex
            Case 0
                Try
                    ...
                    Dim s As String = CboTipo.SelectedIndex & CboEstado.SelectedIndex
                    ...
                    With ObjFactura
                        ...
                        ObjReport.printrptB(False, "", "FAC017.RPT", _
 ...
 _
    ...
    Private Sub chkStockTotal_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkStockTotal.CheckedChanged
        If chkStockTotal.Checked = True Then
            RBENTRE.Enabled = False
            RBAMBOS_INCLU.Enabled = False
            RBSIN_ENTRE.Checked = True
            DTPFECHAINICIOFACTURA.Enabled = False
            DTPFECHAFINALFACTURA.Enabled = False
        Else
            RBENTRE.Enabled = True
            RBAMBOS_INCLU.Enabled = True
            RBAMBOS_INCLU.Checked = True
            DTPFECHAINICIOFACTURA.Enabled = True
            DTPFECHAFINALFACTURA.Enabled = True
        End If
    End Sub
End Class
