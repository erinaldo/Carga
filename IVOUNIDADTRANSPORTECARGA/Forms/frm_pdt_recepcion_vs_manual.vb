Public Class frm_pdt_recepcion_vs_manual
#Region "Variables"
...
#Region "Eventos"
    ...
    Private Sub frm_pdt_recepcion_vs_manual_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub frm_pdt_recepcion_vs_manual_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub frm_pdt_recepcion_vs_manual_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Me.ShadowLabel1.Text = "Consulta de Bultos leídos con Pdt en Recepción contra Forma Manual"
            ...
            If objbultos_leidos_pdt_vs_manual.fn_load_bultos_leidos_recepcion_pdt_vs_manual Then
    ...
    Private Sub btn_filtrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_filtrar.Click
        ...
        objbultos_leidos_pdt_vs_manual.vi_fecha_final = CType(DTPFECHAFINALFACTURA.Value, String)
        'Mod.07/10/2009 -->Omendoza - Pasando al datahelper -  
        If objbultos_leidos_pdt_vs_manual.fn_bultos_leidos_recepcion_pdt_vs_manual() Then
...
#Region "Procedimientos y Funciones"
    ...
    Sub fn_totalizar()
        Try
            ...
            '
            If ll_tot_manual + ll_tot_pda = 0 Then
