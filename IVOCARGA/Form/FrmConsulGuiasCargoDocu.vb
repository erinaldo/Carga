Public Class FrmConsulGuiasCargoDocu
    ...
    Private Sub listar_GUIAS()
        Try
            ...
            End If
            If Not IsNothing(cbidtipo_moneda.SelectedValue) Then
                ObjFactura.IDAGENCIAS = Me.cbidtipo_moneda.SelectedValue
            Else
            ...
            End If
            'datahelper
            dvListar_guias = ObjFactura.FN_CONSUL_GUIAS_CARGO_docu_DG()
            FORMAT_GRILLA3()
    ...
    Private Sub FrmConsulGuiasCargoDocu_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulGuiasCargoDocu_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Consulta de Cargos Documentarios"
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        ObjReport.printrptB(False, "", "GUI010.RPT", _
