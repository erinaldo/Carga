Public Class FrmProcesosVentaContadoGiros
    ...
    Private Sub FrmProcesosVentaContado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If objControlFacturasBol.fnBuscarDatos_rgt(idFacturaBoleta) = True Then
                ...
                txtMONTO_BASE.Text = Format(objControlFacturasBol.monto_base, "###,###,###.00")
                txtMONTO_FLETE.Text = Format(objControlFacturasBol.Total_Costo - objControlFacturasBol.monto_base, "###,###,###.00")
                txtPorcentage.Text = Format(objControlFacturasBol.monto_descuento, "###,###,###.00")
                txtTotalCosto.Text = Format(objControlFacturasBol.Total_Costo, "###,###,###.00")
                txtDevolucion.Text = Format(objControlFacturasBol.Total_Costo, "###,###,###.00")
            End If
