Public Class FrmConsulFactuEmiContaEsta
    ...
    '
    Dim dvIDESTADO_ENVIO As New DataView
    '
    ...
    Private Sub listar_facturas()
        Try
            ...
            'dvListar_facturas = ObjFactura.SP_ConsulFactuEmiContaIV(VOCONTROLUSUARIO)
            dvListar_facturas = ObjFactura.SP_ConsulFactuEmiContaIV()
            '
    ...
    Sub FORMAT_GRILLA3()
        ...
        With FECHA_LLEGADA_BUS
            .HeaderText = "FECHA_LLEGADA"
            .Name = "FECHA_LLEGADA_BUSA"
        ...
        With DGV3
            .Columns.AddRange(RAZON_SOCIAL, TIPO_COMPROBANTE, SERIE_FACTURA, NRO_FACTURA, FECHA_FACTURA, FECHA_LLEGADA_BUS, SIMBOLO_MONEDA, SUB_TOTAL, MONTO_IMPUESTO, TOTAL_COSTO, FORMA_PAGO, LOGIN, ESTADO_REGISTRO, ESTADO_REGISTRO_ENVIO, NOMBRE_AGENCIA, Nombre_Unidad_ORI, Nombre_Unidad_DESTI, TIPO_ENTREGA, FECHA_ENTREGA)

        End With
    End Sub

    Private Sub FrmConsulFactuEmiContaEsta_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulFactuEmiContaEsta_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Consulta Estados de Envio"
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        ObjReport.printrptB(False, "", "FAC014.RPT", _
                        ...
                        "p_idestado_envio;" & .IDESTADO_ENVIO _
                        )
    ...
    DTPFECHAFINALFACTURA.GotFocus, _
        ...
        cbidtipo_entrega.GotFocus, CBIDESTADO_ENVIO.GotFocus
    ...
    Private Sub CBIDUNIDAD_AGENCIA_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CBIDUNIDAD_AGENCIA.KeyPress, cbidtipo_entrega.KeyPress, CBIDESTADO_ENVIO.KeyPress
        If e.KeyChar = Chr(13) Then
            Me.CBIDUNIDAD_AGENCIA_DESTINO.Focus()
        End If
    End Sub

    Private Sub CBIDUNIDAD_AGENCIA_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBIDUNIDAD_AGENCIA.SelectedIndexChanged, cbidtipo_entrega.SelectedIndexChanged, CBIDESTADO_ENVIO.SelectedIndexChanged
        Me.DGV3.DataSource = Nothing
    End Sub
