Public Class FrmAperLiquiTurno
    Dim dto As New ClsLbTepsa.dtoLIQUI_TURNOS
    ...
    Private Sub FrmAperLiquiTurno_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmAperLiquiTurno_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub BTNACEP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNACEP.Click
        Try
            Dim strFecha As String = Me.dtpfecha.Value.ToShortDateString
            Dim strFechaServidor As String = FechaServidor.ToString.Substring(0, 10)

            If CDate(strFecha) > CDate(strFechaServidor) Then
                MessageBox.Show("La Fecha de Apertura no puede ser mayor a la Fecha de Hoy", "Aperturar Turno", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Me.dtpfecha.Focus()
                Return
            End If
            ...
            With dto
                ...
                .FECHA_APER = Me.dtpfecha.Value.ToShortDateString
                .FECHA_CIERRE = "NULL"
                .IMPRESO = 0
                .CERRADO = 0
                .IP = dtoUSUARIOS.IP
                ...
                .IDESTADO_REGISTRO = 1
                'datahelper
                '.SP_INSUPD_LIQUI_TURNOS_(VOCONTROLUSUARIO)
                .SP_INSUPD_LIQUI_TURNOS_()
            End With
            Close()
        Catch ex As Exception
