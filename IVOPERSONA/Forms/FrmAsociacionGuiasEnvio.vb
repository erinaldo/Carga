...
Public Class FrmAsociacionGuiasEnvio
    ...
    Dim dtContacto, dtContactoParalelo, dtRemitente, dtRemitenteParalelo, dtDireccion, dtConsignado, dtDireccion2 As DataTable
    Dim CiudadOrigen As Integer = 0
    Dim CiudadDestino As Integer = 0
    Dim obj As New dtoVentaCargaContado
    Public objGuiaEnvio As New dtoGuiaEnvio
    Dim dsContacto As DataSet
    Dim sNombresCli As String = String.Empty
    Dim sApCli As String = String.Empty
    Dim sAmCli As String = String.Empty
    Dim sTelfCliente As String = String.Empty
    Dim sRazonSocialCliente As String = String.Empty
    Dim iID_TipoDocCli As String = String.Empty
    Dim sReferencia As String = ""
    Dim iTipoDoc As Integer = 0
    ...
    Private Sub FrmAsociacionGuiasEnvio_MenuGrabar() Handles Me.MenuGrabar
        ...
        Try
            If PAGI_SELEC = 3 Then
                ...
                With ObjPRE_GUIAS
                    'Numero de Inicio y Fin de las guias pre-impresas
                    .NRO_GUIA_INI = Me.TBNRO_GUIA_INI.Text
                    .NRO_GUIA_FINAL = Me.TBNRO_GUIA_FINAL.Text
                    .ULTI_NRO_GUIA_IMPRESO = 0

                    'Unidad Agencia Origen
                    If CHKIDUNIDAD_AGENCIA_O.Checked = True Then
                        .IDUNIDAD_AGENCIAS_ORI = Int(COLL_L_UNIDAD_AGENCIA_O.Item(Me.iWin_L_UNIDAD_AGENCIA_O.IndexOf(TXTIDUNIDAD_AGENCIA_O.Text).ToString))
                    Else
                        .IDUNIDAD_AGENCIAS_ORI = 0
                    End If

                    'Agencia Origen
                    If CHKIDAGENCIA_ORIGEN.Checked = True Then
                        .IDAGENCIAS_ORI = CBAGENCIA_ORIGEN.SelectedValue
                    End If

                    'Unidad Agencia Destino
                    If CHKIDUNIDAD_AGENCIA_D.Checked = True Then
                        .IDUNIDAD_AGENCIAS_DESTI = Int(COLL_L_UNIDAD_AGENCIA_D.Item(iWin_L_UNIDAD_AGENCIA_D.IndexOf(TXTIDUNIDAD_AGENCIA_D.Text).ToString))
                    Else
                        .IDUNIDAD_AGENCIAS_DESTI = 0
                    End If

                    'Agencia Destino
                    If CHKIDAGENCIA_DESTINO.Checked = True Then
                        .IDAGENCIAS_DESTI = CBAGENCIA_DESTINO.SelectedValue
                    End If
                    ...
                    'Direccion Remitente
                    If CboDireccion.Text.Trim <> "(SELECCIONE)" Then
                    ...
                    'Consignado
                    If GrdNConsignado.RowCount > 0 Then
                        If ChkCliente2.Checked = True Then
                            .IDCONTACTO_DESTINATARIO = .IDCONTACTO_REMITENTE
                        Else
                            .IDCONTACTO_DESTINATARIO = GrdNConsignado("IDConsignado", row).Value
                        End If
                        .CONTACTO_DESTINATARIO = GrdNConsignado("Nombres", row).Value
                        .NOMBRE_CONSIGNADO = GrdNConsignado("nombre", row).Value
                        .APELLIDO_PATERNO_CONSIGNADO = GrdNConsignado("apepat", row).Value
                        .APELLIDO_MATERNO_CONSIGNADO = GrdNConsignado("apemat", row).Value
                        .NUMERO_DOCUMENTO_CONSIGNADO = GrdNConsignado("Nº Documento", row).Value
                        .IDTIPO_DOCUMENTO_CONSIGNADO = GrdNConsignado("tipo", row).Value
                        .TELEFONO_CONSIGNADO = GrdNConsignado("Telefono", row).Value
                        .CONSIGNADO_MODIFICADO = GrdNConsignado("Modificado", row).Value
                    Else
                    ...
                    If cboDireccion2.Text.Trim <> "(SELECCIONE)" Then
                        .IDDIRECCION_DESTINATARIO = Convert.ToInt32(dtDireccion2.Rows(cboDireccion2.SelectedIndex).Item("iddireccion_consignado").ToString)
                        .DIRECCION_DESTINATARIO = cboDireccion2.Text
                    Else
                    ...
                    .DIRECCION_CONSIGNADO = 0
                    .IDDDEPARTAMENTO_CONSIGNADO = iDepartamentoConsig
                    .IDPROVINCIA_CONSIGNADO = iProvinciaConsig
                    .IDDISTRITO_CONSIGNADO = iDistritoConsig
                    .IDVIA_CONSIGNADO = IDviaConsig
                    .VIA_CONSIGNADO = ViaConsig
                    .NUMERO_CONSIGNADO = NroConsig
                    .MANZANA_CONSIGNADO = ManzanaConsig
                    .LOTE_CONSIGNADO = loteConsig
                    .IDNIVEL_CONSIGNADO = id_NivelConsig
                    .NIVEL_CONSIGNADO = NivelConsig
                    .IDZONA_CONSIGNADO = id_ZonaConsig
                    .ZONA_CONSIGNADO = ZonaConsig
                    .IDCLASIFICACION_CONSIGNADO = id_ClasificacionConsig
                    .CLASIFICACION_CONSIGNADO = ClasificacionConsig
                    .REFERENCIA_CONSIGNADO = sReferencia
...
#End Region
    ...
    Function Validar() As Boolean
        ...
        If CHKIDUNIDAD_AGENCIA_O.Checked = True Then
            If Me.iWin_L_UNIDAD_AGENCIA_O.IndexOf(TXTIDUNIDAD_AGENCIA_O.Text) = -1 Then
                MsgBox("Si va a considerar la unidad de agencia origen en la impresion selecciona un elemento", MsgBoxStyle.Information, "Seguridad del Sistema")
                TXTIDUNIDAD_AGENCIA_O.Focus()
                Exit Function
            End If
        End If

        If CHKIDAGENCIA_ORIGEN.Checked Then
            If Me.CBAGENCIA_ORIGEN.SelectedValue <= 0 Then
                MsgBox("Si va a considerar la agencia de origen en la impresion selecciona un elemento", MsgBoxStyle.Information, "Seguridad del Sistema")
        ...
        If CHKIDUNIDAD_AGENCIA_D.Checked = True Then
            If Me.iWin_L_UNIDAD_AGENCIA_D.IndexOf(TXTIDUNIDAD_AGENCIA_D.Text) = -1 Then
                MsgBox("Si va a considerar la unidad de agencia destino en la impresion selecciona un elemento", MsgBoxStyle.Information, "Seguridad del Sistema")
                TXTIDUNIDAD_AGENCIA_D.Focus()
                Exit Function
            End If
        End If

        If CHKIDAGENCIA_DESTINO.Checked Then
            If Me.CBAGENCIA_DESTINO.SelectedValue <= 0 Then
                MsgBox("Si va a considerar la agencia de destino en la impresion selecciona un elemento", MsgBoxStyle.Information, "Seguridad del Sistema")
                CBAGENCIA_DESTINO.Focus()
                Exit Function
            End If
        End If
        ...
        If dtDireccion2.Rows.Count > 0 And Me.cmbTipo_Entrega.Text = "DOMICILIO" Then
            If (cboDireccion2.Text = "(SELECCIONE)" And cboDireccion2.Text = "AGENCIA") Then
                MsgBox("Seleccione o Ingrese la dirección del consignado", MsgBoxStyle.Information, "Seguridad del Sistema")
                cboDireccion2.Focus()
                Exit Function
            End If
        End If
    ...
    Private Sub FrmAsociacionGuiasEnvio_ClickTabPage4() Handles Me.ClickTabPage4
        ...
        CiudadOrigen = dtoUSUARIOS.m_idciudad
        DiseñaGrdNConsignado()
        Inicio()
    ...
    Private Sub txtiWinOrigen_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TXTIDUNIDAD_AGENCIA_O.KeyUp
        If e.KeyCode = Keys.Enter Then
            If DV_L_UNIDAD_AGENCIA_O.Table.Rows.Count > 0 Then
                For Index As Integer = 0 To DV_L_UNIDAD_AGENCIA_O.Table.Rows.Count - 1
                    If DV_L_UNIDAD_AGENCIA_O.Table.Rows(Index).Item("NOMBRE_UNIDAD").ToString.Trim = TXTIDUNIDAD_AGENCIA_O.Text.Trim Then
                        CiudadOrigen = Convert.ToInt32(DV_L_UNIDAD_AGENCIA_O.Table.Rows(Index).Item("IDUNIDAD_AGENCIA").ToString)
                        Exit For
                    End If
                Next
            End If
            ...
            ObjVentaCargaContado.fnGetAgencias(CiudadOrigen)
    ...
    Private Sub txtiWinDestino_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TXTIDUNIDAD_AGENCIA_D.KeyUp
        If e.KeyCode = Keys.Enter Then
            If DV_L_UNIDAD_AGENCIA_D.Table.Rows.Count > 0 Then
                For Index As Integer = 0 To DV_L_UNIDAD_AGENCIA_D.Table.Rows.Count - 1
                    If DV_L_UNIDAD_AGENCIA_D.Table.Rows(Index).Item("NOMBRE_UNIDAD").ToString.Trim = TXTIDUNIDAD_AGENCIA_D.Text.Trim Then
                        CiudadDestino = Convert.ToInt32(DV_L_UNIDAD_AGENCIA_D.Table.Rows(Index).Item("IDUNIDAD_AGENCIA").ToString)
                        Exit For
                    End If
                Next
            End If
            ...
            Cursor = Cursors.AppStarting
            ObjVentaCargaContado.fnGetAgencias(CiudadDestino)
            Dim dt As New DataTable
            dt = ObjVentaCargaContado.dt_VarAgencias.Copy

            With CBAGENCIA_DESTINO
                .DataSource = dt
                .DisplayMember = "nombre_agencia"
                .ValueMember = "idagencias"
            End With

            If Me.CBAGENCIA_DESTINO.Focused Then
                Me.DespliegaCboAgencia_Origen()
            End If
            Cursor = Cursors.Default
    ...
    Sub Inicio()
        Try
            ...
            dsContacto = objGuiaEnvio.BuscarClienteCredito(scliente, iOpcion, CiudadOrigen, CiudadDestino)

            sNombresCli = IIf(IsDBNull(dsContacto.Tables(0).Rows(0).Item("nombres")), "", dsContacto.Tables(0).Rows(0).Item("nombres"))
            sApCli = IIf(IsDBNull(dsContacto.Tables(0).Rows(0).Item("ap")), "", dsContacto.Tables(0).Rows(0).Item("ap"))
            sAmCli = IIf(IsDBNull(dsContacto.Tables(0).Rows(0).Item("am")), "", dsContacto.Tables(0).Rows(0).Item("am"))
            sTelfCliente = IIf(IsDBNull(dsContacto.Tables(0).Rows(0).Item("telefono")), "", dsContacto.Tables(0).Rows(0).Item("telefono"))
            sRazonSocialCliente = IIf(IsDBNull(dsContacto.Tables(0).Rows(0).Item("razon_social")), "", dsContacto.Tables(0).Rows(0).Item("razon_social"))
            iID_TipoDocCli = dsContacto.Tables(0).Rows(0).Item("tipo").ToString.Trim
            ...
            With Me.cboDireccion2
                dtDireccion2 = dsContacto.Tables(2)
                .DataSource = dtDireccion2
                .DisplayMember = "direccion"
                .ValueMember = "iddireccion_consignado"

                If Me.cmbTipo_Entrega.SelectedValue = TipoEntrega.Domicilio Then
                    If .Items.Count > 2 Then
                        .SelectedIndex = 0
                        '.DroppedDown = True
                        '.Focus()
                ...
                Else
                    '01092011
                    Me.ConvertirTipoEntrega(Me.cmbTipo_Entrega.SelectedValue)
                End If
            End With
    ...
    Private Sub CboRemitente_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    '---------------- Listar las direcciones del consignado ----------------
    Private Sub cmbTipo_Entrega_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cmbTipo_Entrega.SelectedIndexChanged
        Try
            If Not IsReference(cmbTipo_Entrega.SelectedValue) Then
                Dim iidTipo As Integer = cmbTipo_Entrega.SelectedValue
                Me.ConvertirTipoEntrega(cmbTipo_Entrega.SelectedValue)
            End If
        Catch ex As Exception
    ...
    '----------- Asigna Consigando Marcando el Check de Cliente -----------
    Private Sub ChkCliente2_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles ChkCliente2.CheckedChanged
        Static i As Integer = 0
        If ChkCliente2.Checked Then
            If Me.TxtNumDocRemitente.Text.Trim.Length > 0 Or Me.CboRemitente.Text.Trim.Length > 0 Then
                ...
                dr("idcontacto_persona") = 0
                dr("nombres") = Me.CboRemitente.Text.Trim
                dr("nombre") = sNombresCli
                dr("tipo") = iID_TipoDocCli
                dr("nrodocumento") = Me.TxtNumDocRemitente.Text.Trim
                dr("apepat") = sApCli
                dr("apemat") = sAmCli
                ...
                GrdNConsignado("Nº Documento", 0).Value = dtConsignado.Rows(0).Item("nrodocumento").ToString
                GrdNConsignado("Nombres", 0).Value = dtConsignado.Rows(0).Item("nombres").ToString
                GrdNConsignado("Telefono", 0).Value = sTelfCliente
    ...
    '----------- Busca el Consignado por Nro de RUC o DNI, o por Nombre de Consignado -----------
    '------------ 1. Si no encuentra abre una ventana para ingresar nuevo consignado ------------
    '---------------  2. Si encuentra una coincidencia se muestra como consignado ---------------
    '-------- 3. Si encuentra mas de una coincidencia se abre una ventana para seleccionar el consignado --------
    Private Sub TxtConsignado_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs) Handles TxtConsignado.KeyPress
    ...
    Sub BuscarConsignado()
        Try
            ...
            Dim obj As New dtoVentaCargaContado
            Dim ds As DataSet = obj.BuscarConsignado(sConsignado, iOpcion, CiudadDestino)
            ...
            If ds.Tables(0).Rows.Count = 0 Then
                ...
                If Me.cmbTipo_Entrega.SelectedValue = TipoEntrega.Domicilio And cboDireccion2.SelectedIndex > 0 Then
    ...
    '--------- Muestra el Consignado y Actualiza el Grid ---------
    ...
    Private Sub ActualizarGrid(ByVal ds As DataSet)
        ...
        If Me.TXTCODIGO_CLIENTE.Text.Trim = GrdNConsignado("Nº Documento", row).Value AndAlso Me.TXTCODIGO_CLIENTE.Text.Trim <> "" Then Me.ChkCliente2.Checked = True Else Me.ChkCliente2.Checked = False
    ...
    Sub CargarConsignado(ByVal frm As FrmConsignado)
        ...
        If frm.TabConsignado.SelectedIndex = 0 Then
            '***Comentado x NConsignado*****************************
            Dim obj As New dtoVentaCargaContado
            Dim ds As DataSet = obj.BuscarConsignado(frm.TxtNumero.Text, 1, CiudadOrigen)
            If ds.Tables(0).Rows.Count > 0 Then
                dtConsignado = ds.Tables(0)
                Me.MostrarConsignado(ds)
            Else
                MessageBox.Show("El Consignado no tiene Numero de Documento o no ha Seleccionado la Ciudad de Origen", "Titán", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
                Return
            End If
        ElseIf frm.TabConsignado.SelectedIndex = 1 Then
            ...
            If frm.bDirecConsigMod AndAlso cmbTipo_Entrega.SelectedValue = TipoEntrega.Domicilio Then
                Me.cboDireccion2.DataSource = Nothing
                Me.cboDireccion2.Items.Clear()
                '-----------
                ...
                Dim sDireccion As String = IIf(frm.CboVia.SelectedValue = 0, "", frm.CboVia.Text) & " " & frm.TxtVia.Text.Trim & " "
    ...
    Dim bConsignadoNuevo As Boolean = False
    ...
    Private Sub BtnConsignado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnConsignado.Click
        ...
        Dim sApeMConsig As String = ""
        Dim sTelfConsig As String = ""
        Dim iTipo As Integer = 3
        Dim iDepartamento As Integer = 0
        Dim iProvincia As Integer = 0
        Dim iDistrito As Integer = 0
        Dim iId_via As Integer = 0
        Dim sVia As String = ""
        Dim sNumero2 As String = ""
        Dim sManzana As String = ""
        Dim sLote As String = ""
        Dim iId_Nivel As Integer = 0
        Dim sNivel As String = ""
        Dim iId_Zona As Integer = 0
        Dim sZona As String = ""
        Dim iId_Clasificacion As Integer = 0
        Dim sClasificacion As String = ""
        ...
        If Me.GrdNConsignado.Rows.Count = 0 Then bConsignadoNuevo = True
        frm.bConsignadoNuevo = bConsignadoNuevo
        frm.iTipoEntrega = Me.cmbTipo_Entrega.SelectedValue

        iTipoDoc = 0
        If Not (dsContacto.Tables(0) Is Nothing) Then
            iTipoDoc = IIf(IsDBNull(dsContacto.Tables(0).Rows(0).Item("tipo")), "", dsContacto.Tables(0).Rows(0).Item("tipo"))
        End If

        frm.iTipoDoc = iTipoDoc
        frm.sNumeroDoc = Me.TXTCODIGO_CLIENTE.Text.Trim
        frm.snombre = Me.TXTIDPERSONA.Text.Trim
        frm.idUnidadAgencias = CiudadDestino
