Public Class FrmRangoEtiquetas
...
#End Region
    ...
    Private Sub btnAcep_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAcep.Click
        ...
        Me.NumeUDfinal.Value = Me.NumeUDini.Value
        If total_bultos < Me.NumeUDfinal.Value Then
            If MsgBox("La cantidad no puede ser mayor que el total bultos...", MsgBoxStyle.Critical, "Seguridad Sistemas") Then
                blnSalir = False
                Exit Sub
            End If
        End If
        If Me.NumeUDini.Value < 1 Then
            If MsgBox("La cantidad no puede ser menor o igual que cero...", MsgBoxStyle.Critical, "Seguridad Sistemas") Then
                blnSalir = False
                Exit Sub
            End If
        End If
        ...
        If Me.txtMotivo.Text.Trim.Length = 0 Then
            MsgBox("Debe ingresar el motivo de la reimpresión", MsgBoxStyle.Information, "Seguridad Sistemas")
            blnSalir = False
            txtMotivo.Focus()
            Exit Sub
        End If
    ...
    Private Sub FrmRangoEtiquetas_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmRangoEtiquetas_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
        Acceso.Eliminar(Me, G_Fila)
    End Sub

    Private Sub FrmRangoEtiquetas_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub NumeUDini_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NumeUDini.ValueChanged
