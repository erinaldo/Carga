...
Public Class dtoFrmReportxy
    ...
    Public Sub GenerarReporte(Optional ByVal LandScape As Boolean = False, Optional ByVal Tipo As String = "Carta")
        ...
        For Each ps In DocImprimir.PrinterSettings.PaperSizes
            If "Sobre 6 3/4: 165 x 92 mm".ToLower = ps.PaperName.ToString.ToLower Then
                psActivo = ps
                Exit For
            End If
        Next
    ...
    Public Function ImprimirTab(ByVal ParamArray Texto() As Object) As Boolean
        ...
        Dim cont As Integer, ancho As Single, alto As Single, Alineacion As ContentAlignment, Marco As Boolean, Relleno As Brush, Separador As Separadores
...
End Class
Module ModDemo
    ' Determina si el Valor se encuentra en la lista
