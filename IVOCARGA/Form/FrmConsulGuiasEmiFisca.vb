Public Class FrmConsulGuiasEmiFisca
    ...
    Private Sub listar_GUIAS()
        Try
            ...
            'datahelper
            'dvListar_guias = ObjFactura.FN_CONSUL_GUIAS_EMI_DG2(VOCONTROLUSUARIO)
            dvListar_guias = ObjFactura.FN_CONSUL_GUIAS_EMI_DG2()
    ...
    Sub FORMAT_GRILLA3()
        ...
        With DGV3
            ...
            .Columns.AddRange(NOMBRE_AGENCIA, LOGIN, RAZON_SOCIAL, SERIE_GUIA_ENVIO, NRO_GUIA, FECHA_GUIA, FORMA_PAGO, SIMBOLO_MONEDA, SUB_TOTAL, MONTO_IMPUESTO, TOTAL_COSTO)

        End With
    End Sub

    Private Sub FrmConsulGuiasEmiFisca_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulGuiasEmiFisca_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Consulta de Guias Emitidas por Origen y Destino"
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        ObjReport.printrptB(False, "", "FLZ001.RPT", _
                        "p_IDAGENCIAS;" & .IDAGENCIAS, _
                        "p_idusuario_personal;" & .IDUSUARIO_PERSONAL, _
                        "p_fecha_inicio;" & .FECHA_INICIO, _
                        "p_fecha_final;" & .FECHA_FINAL, _
                        "p_IDUNIDAD_AGENCIA;" & .IDUNIDAD_ORIGEN, _
                        "p_AGENCIA;" & IIf(IsNothing(Me.cmbAgencia.SelectedValue), "", Me.cmbAgencia.Text), _
                        "p_USUARIO;" & IIf(IsNothing(Me.cmbUsuarios.SelectedValue), "", Me.cmbUsuarios.Text), _
                        "p_IDUNIDAD_AGENCIA_DESTINO;" & .IDUNIDAD_DESTINO, _
                        "p_RANGO_FECHA;" & "Del " & Me.DTPFECHAINICIOFACTURA.Value.ToShortDateString & " Al " & Me.DTPFECHAFINALFACTURA.Value.ToShortDateString)
