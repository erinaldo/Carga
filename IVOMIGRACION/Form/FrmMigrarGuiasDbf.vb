Public Class FrmMigrarGuiasDbf
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        listar_GUIAS(0)
    End Sub
    Private Sub listar_GUIAS(ByVal P_OPERACION As Double)
        Try
            ...
            Dim P_FACTURADO As Double, P_EXPORTADO As Double

            If Me.RBFACTU.Checked = True Then
                P_FACTURADO = 1
            End If
            If Me.RBSIN_FACTU.Checked = True Then
                P_FACTURADO = 0
            End If
            If Me.RBFACTU_Y_SIN_FACTU.Checked = True Then
                P_FACTURADO = -1
            End If
            ...
            dvListar_guias = ObjMigra.FN_L_GUIAS_ENVIO(ObjFactura.IDAGENCIAS, ObjFactura.IDFORMA_PAGO, _
            ObjFactura.IDUSUARIO_PERSONAL, ObjFactura.IDTIPO_MONEDA, ObjFactura.IDPERSONA, ObjFactura.FECHA_INICIO, ObjFactura.FECHA_FINAL, P_EXPORTADO, P_FACTURADO, P_OPERACION)
            '
            dgv1.DataSource = dvListar_guias
            '
    ...
    Private Sub FrmMigrarGuiasDbf_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmMigrarGuiasDbf_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Exportación de Guías a DBF"
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        .IDGUIAS_ENVIO = Me.dvListar_guias.Table.Rows(Me.dgv1.CurrentRow.Index)("IDGUIAS_ENVIO")
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If Me.TBRUTA.Text = "" Then
            ...
            Exit Sub
        End If
        If Me.dvListar_guias.Count <= 0 Then
        ...
        filename = "G" & Format(Date.Now, "ddMM_HH") & ".DBF"
        ...
        pb.Minimum = 0
        pb.Maximum = dvListar_guias.Count - 1
        pb.Visible = True
        Try
            ...
            For i As Integer = 0 To dvListar_guias.Count - 1
                ...
                & "CANSOB06  " _
                & ") values(" _
                & dvListar_guias.Table.Rows(i)("CODOFI06") & ", " _
                & dvListar_guias.Table.Rows(i)("OFIORI06") & ", " _
                & dvListar_guias.Table.Rows(i)("NSERIE06") & ", " _
                & dvListar_guias.Table.Rows(i)("NUMGUI06") & ", " _
                & dvListar_guias.Table.Rows(i)("OFIDES06") & ", " _
                & IIf(dvListar_guias.Table.Rows(i).IsNull("FECLIQ06") = True, "NULL", "'" & dvListar_guias.Table.Rows(i)("FECLIQ06") & "'") & ", " _
                & IIf(dvListar_guias.Table.Rows(i).IsNull("FECEMI06") = True, "NULL", "'" & dvListar_guias.Table.Rows(i)("FECEMI06") & "'") & ", '" _
                & IIf(Len(dvListar_guias.Table.Rows(i)("NOMCON06")) > 40, Mid(dvListar_guias.Table.Rows(i)("NOMCON06"), 1, 40), dvListar_guias.Table.Rows(i)("NOMCON06")) & "', " _
                & dvListar_guias.Table.Rows(i)("PORIGV06") & ", " _
                & dvListar_guias.Table.Rows(i)("IMPBRU06") & ", " _
                & dvListar_guias.Table.Rows(i)("IMPIGV06") & ", " _
                & dvListar_guias.Table.Rows(i)("IMPGIR06") & ", " _
                & dvListar_guias.Table.Rows(i)("CANTID06") & ", " _
                & dvListar_guias.Table.Rows(i)("TIPSER06") & ", " _
                & dvListar_guias.Table.Rows(i)("TIPDOC06") & ", '" _
                & dvListar_guias.Table.Rows(i)("TIPMON06") & "', '" _
                & dvListar_guias.Table.Rows(i)("CONDIC06") & "', " _
                & dvListar_guias.Table.Rows(i)("DESCTO06") & ", " _
                & dvListar_guias.Table.Rows(i)("NROMEM06") & ", '" _
                & dvListar_guias.Table.Rows(i)("FECDIG06") & "','" _
                & dvListar_guias.Table.Rows(i)("HORDIG06") & "', " _
                & dvListar_guias.Table.Rows(i)("USUDIG06") & ", '" _
                & dvListar_guias.Table.Rows(i)("FECMOD06") & "', '" _
                & dvListar_guias.Table.Rows(i)("HORMOD06") & "', " _
                & dvListar_guias.Table.Rows(i)("CODRUC06") & ", " _
                & dvListar_guias.Table.Rows(i)("TARBAS06") & ", " _
                & dvListar_guias.Table.Rows(i)("TARPES06") & ", " _
                & dvListar_guias.Table.Rows(i)("CODART06") & ", " _
                & dvListar_guias.Table.Rows(i)("PESVOL06") & ", " _
                & dvListar_guias.Table.Rows(i)("PESKIL06") & ", " _
                & dvListar_guias.Table.Rows(i)("CODBUL06") & ", " _
                & dvListar_guias.Table.Rows(i)("NUMFAC06") & ", " _
                & dvListar_guias.Table.Rows(i)("DOCGUI06") & ", " _
                & dvListar_guias.Table.Rows(i)("CODSUC06") & ", " _
                & dvListar_guias.Table.Rows(i)("FECDEV06") & ", " _
                & dvListar_guias.Table.Rows(i)("FLGDEV06") & ", " _
                & dvListar_guias.Table.Rows(i)("FECIMP06") & ", " _
                & dvListar_guias.Table.Rows(i)("CANSOB06") & " " _
                & ")"
                ...
                pb.Value = i
            Next
            MsgBox("Se exportaron " & Str(dvListar_guias.Count) & " registros" & Chr(13) & "El nombre del archivo es " & filename, MsgBoxStyle.Information, "Segurdidad del Sistema")
        Catch EXs As SystemException
            MsgBox(EXs.ToString, MsgBoxStyle.Information, "Seguridad del Sistema")
            InputBox("copialo", "sql", sql)
