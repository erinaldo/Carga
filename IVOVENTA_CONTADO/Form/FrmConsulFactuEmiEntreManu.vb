Public Class FrmConsulFactuEmiEntreManu
    ...
    Private Sub listar_facturas()
        Try
            ...
            dvListar_facturas = ObjFactura.sp_ConsulFactuEmiEntreManu(P_ENTRE)
            '
    ...
    Sub FORMAT_GRILLA3()
        ...
        With DGV3
            .Columns.AddRange(RAZON_SOCIAL, TIPO_COMPROBANTE, SERIE_FACTURA, NRO_FACTURA, FORMA_PAGO, FECHA_REGISTRO, FECHA_FACTURA, FECHA_SALIDA, FECHA_LLEGADA, FECHA_ENTREGA, FECHA_ACTUALIZACION, DIFERENCIA_DIAS, LOGIN, ESTADO_REGISTRO, ESTADO_REGISTRO_ENVIO, NOMBRE_AGENCIA, Nombre_Unidad_ORI, Nombre_Unidad_DESTI, TIPO_ENTREGA)

        End With
    End Sub

    Private Sub FrmConsulFactuEmiEntreManu_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulFactuEmiEntreManu_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.ShadowLabel1.Text = "Entregas Manuales"
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        ObjReport.printrptB(False, "", "FAC024.RPT", _
