Public Class FrmConsulFactuCompartivo
    Public pl_formulario As Long
    ...
    Public Sub listar_facturas()
        Try
            ...
            'datahelper
            'dvListar_facturas = ObjFactura.FN_ConsulFactuEmi(cnn)
            dvListar_facturas = ObjFactura.FN_ConsulFactuEmi()
            FORMAT_GRILLA3()
    ...
    Sub FORMAT_GRILLA3()
        ...
        With MES_CORRESPONDE
            ...
            .Name = "fecha_CORRESPONDE"
            .DataPropertyName = "fecha_CORRESPONDE"
            .Width = 80
            .SortMode = DataGridViewColumnSortMode.NotSortable
            .DefaultCellStyle.Alignment = DataGridViewContentAlignment.BottomLeft
            .ReadOnly = True
    ...
    Private Sub FrmConsulFactuCompartivo_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    End Sub

    Private Sub FrmConsulFactuCompartivo_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        G_Fila = Acceso.ObtieneFila(Me, Me.hnd)
    ...
    Private Sub FrmConsulFactuEmiti_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            pl_formulario = 1
            Me.ShadowLabel1.Text = "Cuadro comparativo de facturación crédito"
    ...
    Private Sub txtidpersona_LostFocus1(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtidpersona.LostFocus

    End Sub
    'Private Sub FrmConsulFactuEmiti_MenuImprimir() Handles Me.MenuImprimir
    Public Overridable Sub FrmConsulFactuEmiti_MenuImprimir() Handles Me.MenuImprimir
        Try
            ObjReport.Dispose()
        Catch
            ...
            Case 0
                Try
                    ...
                    With ObjFactura
                        ...
                        If Me.dvListar_facturas.Table.Rows.Count > 0 Then
                        ...
                        Else
                            PREFACTURA = ""
                        End If
                        If pl_formulario = 1 Then
                            ObjReport.printrpt_sub_report("GE002.rpt", False, "", "GE001.rpt", _
    ...
    "p_titulo;" & p_titulo, _
                        ...
                        Else
                            ObjReport.printrpt_sub_report("GE101_2.rpt", False, "", "GE100-1.rpt", _
                                                 "p_idpersona;" & .IDPERSONA, _
                                                 "p_rango_fecha;" & "(Desde el " & .FECHA_INICIO & " hasta el " & .FECHA_FINAL & ")", _
                                                 "p_titulo;" & p_titulo, _
                                                 "p_fecha_inicial;" & .FECHA_INICIO, _
