Public Class FrmBuscaClienca
    ...
    Private Sub BAcep_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BAcep.Click
        nFrmOpciones.Txtnu_docu_suna.Text = dgv1.CurrentRow.Cells("nu_docu_suna").Value
        nFrmOpciones.Txtrazon_social.Text = dgv1.CurrentRow.Cells("razon_social").Value
        nFrmOpciones.Txtrazon_social.Tag = dgv1.CurrentRow.Cells("idpersona").Value
        Close()
    End Sub
    ...
    Private Sub BCance_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BCance.Click
        ...
        nFrmOpciones.Txtnu_docu_suna.Text = ""
        nFrmOpciones.Txtrazon_social.Text = ""
        nFrmOpciones.Txtrazon_social.Tag = ""
    End Sub
